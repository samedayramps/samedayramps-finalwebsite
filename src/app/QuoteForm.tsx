            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center mt-6">
                <button 
                  ...
                  className="px-8 py-3 bg-[#eafc2b] hover:bg-[#dceb29] text-gray-900 font-bold rounded-md focus:outline-none focus:ring-2 focus:ring-[#eafc2b] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
                >
